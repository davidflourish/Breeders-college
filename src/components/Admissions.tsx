...
export function Admissions({ onNavigate }: AdmissionsProps) {
  const steps = [
    {
      step: 1,
      title: 'Submit Application',
      description: 'Complete online application form with required documents and academic background information',
      icon: FileText,
    ...
    },
    {
      ...
      description: 'Academic assessment, entrance examination, and family interview with admissions committee',
      icon: Users,
  ...
  const fees = [
    { level: 'Nursery', registration: '₦25,000', tuition: '₦750,000', development: '₦40,000', total: '₦815,000' },
    { level: 'Primary', registration: '₦30,000', tuition: '₦850,000', development: '₦50,000', total: '₦930,000' },
    { level: 'JSS', registration: '₦35,000', tuition: '₦950,000', development: '₦60,000', total: '₦1,045,000' },
    { level: 'SSS', registration: '₦40,000', tuition: '₦1,050,000', development: '₦70,000', total: '₦1,160,000' }
  ];

  const scholarships = [
    {
      name: 'Academic Excellence',
      description: 'For students with outstanding academic performance and leadership potential',
      discount: '50%',
      color: 'from-blue-500 to-purple-600'
    },
    {
      name: 'STEM Achievement',
      description: 'For students demonstrating exceptional aptitude in Science, Technology, Engineering, and Mathematics',
      discount: '35%',
      color: 'from-green-500 to-teal-600'
    },
    {
    ...
    <section id="admissions" className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%233B82F6' fill-opacity='1'%3E%3Cpath d='m36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm-16-16v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
        }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          <div className="inline-flex items-center bg-blue-100 rounded-full px-4 py-2 text-blue-700 mb-6">
            ...
            <span className="font-medium">Join Our Educational Community</span>
          </div>
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            ...
            educational environment and contribute positively to our school community.
          </p>
        </div>
        ...
        <div className="mb-24">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our admission process is designed to identify students who align with our educational values 
        ...
        <div className="mb-20">
          ...
          <div className="text-center mt-8">
            <p className="text-gray-500 mb-4">
              * Fees include learning materials, technology resources, and extracurricular activities.
            </p>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-purple-700 rounded-3xl p-8 lg:p-12 text-white text-center">
          <h3 className="text-3xl font-bold mb-4">Ready to Join Our Educational Community?</h3>
          <p className="text-blue-100 mb-8 max-w-3xl mx-auto text-lg">
            Start your child's journey in an environment where modern education meets traditional values. 
